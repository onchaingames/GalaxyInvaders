...
import PlanetGrid from '~~/components/example-ui/planetGrid';
...
export const Planets = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-[url('/assets/gradient-bg.png')] bg-[length:100%_100%] py-10 px-5 sm:px-0 lg:py-auto max-w-[100vw] ">
      ...
      <div
        className={`flex hidden flex-col max-w-md bg-base-200 bg-opacity-70 rounded-2xl shadow-lg px-5 py-4 w-full ${
