        ...
        <tbody>
          {stats.map((stat, index) => (
            <tr key={index} className="">
              ...
              <td className="border px-4 border-slate-700">{stat.deposit ? <button className="bg-green-600 hover:bg-green-800 text-white font-bold py-2 px-4 rounded" onClick={handleButtonClick}>Deposit</button> : ''}</td>
              <td className="border py-2 px-4 border-slate-700">{stat.withdraw ? <button className="bg-green-600 hover:bg-green-800 text-white font-bold py-2 px-4 rounded" onClick={handleButtonClick}>Withdraw</button> : ''}</td>
            </tr>
          ))}
        </tbody>
      </table>
