      ...
      <div className="flex items-center flex-col flex-grow pt-10">
        <div className="px-5">
          <h1 className="text-center mb-10">
            ...
            <span className="block text-green-600 text-6xl font-bold">{TITLE}</span>
          </h1>
          <p className="text-center italic">
          A Defi Game | Battle For Staked Eth Yield
          </p>
          <ul className="list-none mt-10">
            <li className="mb-2 font-bold">💰 Stake stEth to Mint a spaceship NFT and earn boosted yield up to 35% in {UTILITY_TOKEN.emoji}{UTILITY_TOKEN.symbol}</li> 
        ...
        <div className="flex flex-col bg-base-200 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
          <Link href="/galaxy" passHref className="text-link ">
        ...
        <div className="mt-10 w-[800px] ">
            <h2 className="text-title text-3xl mb-4 text-center ">Rules of the Galaxy</h2>
            ...
            <h3 className="text-xl font-bold mb-2">ALIEN BATTLE</h3>
            <ul className="list-none mb-4">
            ...
            <h3 className="text-xl font-bold mb-2">SHIP BATTLE</h3>
            ...
            <h2 className="text-2xl mt-10 text-center font-bold">Galaxy Tokenomics</h2>
            <h3 className="text-xl font-bold mb-2">AMMO TOKEN</h3>
            <ul className="list-none mb-4">
            ...
            <h3 className="text-xl font-bold mb-2">GALAXY TOKEN</h3>
            <ul className="list-none mb-4">
            ...
            <h3 className="text-xl font-bold mb-2">TOKEN ALLOCATION</h3>
            ...
            <h3 className="text-xl font-bold mb-2">SHIP NFT</h3>
